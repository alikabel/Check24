...
class APIClient: HTTPClient {
     ...
     */
    static func requestAPI<T:JSONMappable>(_ method: Alamofire.HTTPMethod, url: URL, headers: [String:String]) -> Task<Progress, T, NSError> {
        return super.request(method, url: url, headers: headers)
